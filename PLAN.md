...
A release is the full cycle including the apt push, which is the step a release
...
Linux goes ahead of Windows in the order, and that step had been skipped.
...
winget's `msstore` source meanwhile, which is how `ship` reads it back.
